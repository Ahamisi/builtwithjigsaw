...
<div id="websites" v-cloak>
    <div class="text-center mt-8 pt-8 text-sm">
        ...
        <a v-for="color, thisType in colors" @click="filterType(thisType)" :class="{'cursor-pointer inline-block pb-2 px-2 md:px-4 lg:px-8 lg:mx-4 text-grey-darkest': true, 'text-purple underline': type == thisType}">{| _.startCase(thisType) |}</a>
    </div>
